...
export async function introspectBus(obj) {
  ...
  return processXML(xml, obj);
}

export async function processXML(xml, obj) {
...
DBusInterface.prototype.subscribe = async function subscribe(
  signame,
  callback,
) {
...
DBusInterface.prototype.unsubscribe = async function unsubscribe(
  signame,
  callback,
) {
  var bus = this.$parent.service.bus;
