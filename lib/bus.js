...
import { introspectBus as introspect } from "./introspect.js";

export default function bus(conn, opts) {
    ...
    if (
      ...
      if (deferred) {
        ...
        if (msg.type === constants.messageType.methodReturn) {
          ...
          deferred.reject(args); // body as first argument
        }
      }
      ...
      var handler = self.methodCallHandlers[self.mangle(msg)];
      if (handler) {
